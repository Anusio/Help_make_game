 ...
 */
public class CovolveFilter extends AbstractBufferedImageOp {
	 ...
	 */
	public CovolveFilter(float[] matrix) {
	 ...
	 */
	public CovolveFilter(int rows, int cols, float[] matrix) {
	 ...
	 * @param matrix an array of 9 floats containing the kernel
	 */
	public CovolveFilter(Kernel kernel) {
		this.kernel = kernel;	
	}
